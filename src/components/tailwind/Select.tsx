...
const Select: FC<SelectProps> = ({ options, value, onChange }) => {
  return (
    <Box display="inline-block" position="relative" className="w-64">
      <Box
        ...
        rounded
        shadow
        className="appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 leading-tight focus:outline-none focus:shadow-outline"
      >
        {options.map((option) => (
